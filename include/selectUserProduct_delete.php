        ...
        if ($product_total == 0) {
            ...
            if ( $result = $stmt->get_result()) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <td><a type="button" class="btn btn-green my-3 p-2"  onclick="return confirm(\' Do you want to delete this record? \')" href ="delete_product_selectOneProduct.php?product_id='.$row["product_id"].'"> Delete Product </a></td>
                    </tr>';
